  ...
  return (
    <Layout tab="Home">
      ...
      <Box display={{ _: "none", tablet: "block" }}>
        ...
        <Text>
          I'm in the process of designing a new personal website, but for the moment, this layout is inspired by <ExtLink href="https://willium.com"/>William Strimling</ExtLink>.
        </Text>
